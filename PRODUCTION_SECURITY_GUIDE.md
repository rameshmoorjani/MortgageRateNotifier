...
aws ssm put-parameter \
  ...
  --value "your-actual-fred-api-key-here" \
  --type SecureString
```
...
secrets:
  fred_api_key:
    ...
    # Then: echo "your-actual-fred-api-key-here" | docker secret create fred_api_key -
```
...
kubectl create secret generic fred-api-key \
  --from-literal=api-key=your-actual-fred-api-key-here
```
...
#### Heroku:
```bash
heroku config:set FRED_API_KEY=your-actual-fred-api-key-here
```
